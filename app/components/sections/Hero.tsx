      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="max-w-3xl">
          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-5xl lg:text-6xl">
            Tu monotributo, sin complicaciones
          </h1>

          <p className="mt-6 text-lg leading-8 text-white/90 sm:text-xl">
            Somos expertos en alta de monotributo, asesoramiento impositivo y
            gestión contable para autónomos y pequeñas empresas. Nos ocupamos de
            todo para que vos te dediques a lo tuyo.
          </p>

          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Button as="a" href={WHATSAPP_URL} variant="secondary" size="lg">
              <svg
